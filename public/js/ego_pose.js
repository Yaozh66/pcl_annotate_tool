...
class EgoPose
{
    ...
    load_ego_pose(){
        ...
        xhr.onreadystatechange = function () {
            ...
            // console.log(_self.world.frameInfo.frame, "egopose", "loaded",_self.egoPose);
        ...
        if(this.world.frameInfo.scene.substring((0,4)=="nusc"))
            xhr.open('GET', "/load_ego_pose"+"?scene="+this.world.frameInfo.scene+"&frame="+this.world.frameInfo.frame_index, false);
        else
            xhr.open('GET', "/load_ego_pose"+"?scene="+this.world.frameInfo.scene+"&frame="+this.world.frameInfo.frame, false);
        xhr.send();
    };
